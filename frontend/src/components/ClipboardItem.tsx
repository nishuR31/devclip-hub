  ...
  return (
    <div className="group relative rounded-lg border bg-card p-3 transition-all hover:border-primary/30 hover:shadow-sm animate-fade-in">
      <div className="mb-2 flex items-center gap-2">
        <span
          className={`inline-flex items-center gap-1 rounded-md px-1.5 py-0.5 text-xs font-medium ${typeColors[entry.type]}`}
        >
        ...
        {entry.pinned && (
          <Badge
            variant="secondary"
            className="h-5 gap-1 bg-primary/10 text-primary text-xs"
          >
