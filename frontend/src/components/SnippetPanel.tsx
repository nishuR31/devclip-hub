    ...
    <div className="flex h-full flex-col">
      ...
      {showAdd && canEdit && (
        <div className="border-b p-3 space-y-2 animate-fade-in">
          ...
          <Input
            ...
            placeholder="Tags (comma separated): api, debug, sql"
            className="h-8 text-xs"
          />
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2">
        ...
        : filtered.map((s) => (
            <div
              key={s.id}
              className="group rounded-lg border bg-card p-3 animate-fade-in"
            >
              <div className="mb-1 flex items-center gap-2">
                ...
                {s.tags.map((t) => (
                  <Badge
                    key={t}
                    variant="secondary"
                    className="h-4 text-[10px] gap-0.5"
                  >
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex gap-1">
                    <Button
                      ...
                      className="h-6 w-6"
                      onClick={() => {
                        onUpdate?.(s.id, { content: editContent });
                        setEditingId(null);
                      }}
                    >
