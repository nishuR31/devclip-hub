...
export async function listPlans(_req: Request, res: Response) {
  ...
  return sendSuccess(res, "Plans fetched", 200, plans);
}
...
export async function getMySubscription(req: Request, res: Response) {
  ...
  return sendSuccess(res, "Subscription fetched", 200, sub);
}

export async function cancelSubscription(req: Request, res: Response) {
  const sub = await subscriptionService.cancelAtPeriodEnd(req.user!.id);
  return sendSuccess(res, "Subscription cancellation scheduled", 200, sub);
}
...
export async function reactivateSubscription(req: Request, res: Response) {
  ...
  return sendSuccess(res, "Subscription reactivated", 200, sub);
}
